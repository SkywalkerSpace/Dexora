    ...
    def __init__(self, xml_path: str):
        ...
        if _env_flag("AIRBOT_MUJOCO_GUI", False):
            try:
                ...
                # Start with a useful framing, but keep a FREE camera.  A
                # fixed camera would look right initially yet disable the
                # usual mouse orbit/pan/zoom controls in the viewer.
                self.viewer.cam.type = self.mujoco.mjtCamera.mjCAMERA_FREE
                self.viewer.cam.lookat[:] = [0.35, 0.0, 0.30]
